...
static struct ast_rtp_glue sccp_rtp = {
	/* *INDENT-OFF* */
	.type = SCCP_TECHTYPE_STR, .get_rtp_info = sccp_astgenwrap_get_rtp_info, .get_vrtp_info = sccp_astgenwrap_get_vrtp_info, .update_peer = sccp_astwrap_update_rtp_peer, .get_codec = sccp_astwrap_getCodec,
	/* *INDENT-ON* */
};
#endif
